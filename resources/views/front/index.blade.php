...
@section('content')
                    ...
                    <div class="about-img">
                        <div class="grid-img">
                            <div class="grid-img-inner">
                                <img src="{{asset('public/front/assets/img/about/about_1.png')}}" class="image-responsive" alt="office_image" />
                            </div>
                            <div class="grid-img-inner">
                                <img src="{{asset('public/front/assets/img/about/about_2.png')}}" class="image-responsive" alt="office_image" />
                            </div>
                            <div class="grid-img-inner">
                                <img src="{{asset('public/front/assets/img/about/about_3.png')}}" class="image-responsive" alt="office_image" />
                            </div>
                            <div class="grid-img-inner">
                                <img src="{{asset('public/front/assets/img/about/about_4.png')}}" class="image-responsive" alt="office_image" />
                            </div>
                        </div>
                        <div class="logo-overlay">
                            <img src="{{asset('public/front/assets/img/logos/logo.png')}}" alt="logo_without_slogan" />
                        </div>
                        <div class="shape">
                            <img src="{{asset('public/front/assets/img/resource/shape_2.png')}}" alt="shape" class="shape-inner" />
                            <img src="{{asset('public/front/assets/img/resource/shape_4.png')}}" alt="shape" class="shape-inner" />
                            <img src="{{asset('public/front/assets/img/resource/shape_2.png')}}" alt="shape" class="shape-inner" />
                        </div>
                    </div>
                </div>
    ...
    <section id="featured-service" class="featured-service-section pt-100 pb-70 bg-light">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 col-md-12 pb-30">
                    <div class="featured-service-image">
                        <img src="{{asset('public/front/assets/img/resource/service_left.png')}}" alt="service_illustration" />
                    </div>
                </div>
        ...
        <div class="shape">
            <img src="{{asset('public/front/assets/img/resource/Illustration_Cloud.png')}}" alt="shape" class="shape-inner" />
            <img src="{{asset('public/front/assets/img/resource/Illustration_Settings.png')}}" alt="shape" class="shape-inner" />
        </div>
    </section>
    <!--end service section-->
            ...
            <div class="team-slider owl-carousel">
                <div class="team-item">
                    <div class="team-image">
                        <img src="{{asset('public/front/assets/img/team/team_1.jpg')}}" alt="team-member" />
                    </div>
                ...
                <div class="team-item">
                    <div class="team-image">
                        <img src="{{asset('public/front/assets/img/team/team_2.jpg')}}" alt="team-member" />
                    </div>
                    <div class="team-content">
                        <h5>
                ...
                <div class="team-item">
                    <div class="team-image">
                        <img src="{{asset('public/front/assets/img/team/team_3.jpg')}}" alt="team-member" />
                    </div>
                    <div class="team-content">
                        <h5>
                ...
                <div class="team-item">
                    <div class="team-image">
                        <img src="{{asset('public/front/assets/img/team/team_4.jpg')}}" alt="team-member" />
                    </div>
                    <div class="team-content">
                        <h5>
            ...
            <div class="video-content">
                <div class="video-box">
                    <figure class="video-image">
                        <img src="{{asset('public/front/assets/img/background/intro_video.png')}}" alt="video" />
                    </figure>
        ...
        <div class="container">
            ...
            <div class="tesimonial-grid">
                <div class="dot active">
                    <img src="{{asset('public/front/assets/img/clients/client_1.png')}}" alt="client-1" />
                </div>
                <div class="dot">
                    <img src="{{asset('public/front/assets/img/clients/client_2.png')}}" alt="client-2" />
                </div>
                <div class="dot">
                    <img src="{{asset('public/front/assets/img/clients/client_3.png')}}" alt="client-3" />
                </div>
                <div class="dot">
                    <img src="{{asset('public/front/assets/img/clients/client_4.png')}}" alt="client-4" />
                </div>
                <div class="dot">
                    <img src="{{asset('public/front/assets/img/clients/client_5.png')}}" alt="client-5" />
                </div>
                <div class="dot">
                    <img src="{{asset('public/front/assets/img/clients/client_6.png')}}" alt="client-5" />
                </div>
                <div class="testimonial-slider owl-carousel">
                    <div class="slider-item">
                        <div class="qoute-icon">
                            <img src="{{asset('public/front/assets/img/resource/quotation.png')}}" alt="quotation" />
                        </div>
                        ...
                        <div class="client">
                            <div class="client-img">
                                <img src="{{asset('public/front/assets/img/clients/client_7.png')}}" alt="client-1" />
                            </div>
                    ...
                    <div class="slider-item">
                        ...
                        <div class="client">
                            <div class="client-img">
                                <img src="{{asset('public/front/assets/img/clients/client_8.png')}}" alt="client-2" />
                            </div>
                            <div class="client-info">
                                <h6>Rosalina D.</h6>
                                <span>CEO & Manager</span>
                    ...
                    <div class="slider-item">
                        ...
                        <div class="client">
                            <div class="client-img">
                                <img src="{{asset('public/front/assets/img/clients/client_9.png')}}" alt="client-1" />
                            </div>
                            <div class="client-info">
                                <h6>Sam McLean</h6>
                                <span>CEO & Manager</span>
                ...
                <div class="overlay-img">
                    <img src="{{asset('public/front/assets/img/background/Testimonial_bg.png')}}" alt="Testimonial_bg" />
                </div>
            </div>
            <!-- tesimonial-grid -->
        </div>
        <div class="shape">
            <img src="{{asset('public/front/assets/img/resource/shape_6.png')}}" alt="shape" class="shape-inner" />
            <img src="{{asset('public/front/assets/img/resource/Ellipse_1.png')}}" alt="shape" class="shape-inner" />
            <img src="{{asset('public/front/assets/img/resource/Rectangle_1.png')}}" alt="shape" class="shape-inner" />
            <img src="{{asset('public/front/assets/img/resource/Ellipse_1.png')}}" alt="shape" class="shape-inner" />
            <img src="{{asset('public/front/assets/img/resource/Rectangle_1.png')}}" alt="shape" class="shape-inner" />
            <img src="{{asset('public/front/assets/img/resource/shape_2.png')}}" alt="shape" class="shape-inner" />
        </div>
        ...
        <div class="container">
            <div class="partner-slider owl-carousel">
                <div class="partner-item">
                    <img src="{{asset('public/front/assets/img/partner/partner_1.png')}}" alt="image" />
                    <img src="{{asset('public/front/assets/img/partner/partner_hover_1.png')}}" alt="partner" />
                </div>
                <div class="partner-item">
                    <img src="{{asset('public/front/assets/img/partner/partner_2.png')}}" alt="image" />
                    <img src="{{asset('public/front/assets/img/partner/partner_hover_2.png')}}" alt="partner" />
                </div>
                <div class="partner-item">
                    <img src="{{asset('public/front/assets/img/partner/partner_3.png')}}" alt="image" />
                    <img src="{{asset('public/front/assets/img/partner/partner_hover_3.png')}}" alt="partner" />
                </div>
                <div class="partner-item">
                    <img src="{{asset('public/front/assets/img/partner/partner_4.png')}}" alt="image" />
                    <img src="{{asset('public/front/assets/img/partner/partner_hover_4.png')}}" alt="partner" />
                </div>
                <div class="partner-item">
                    <img src="{{asset('public/front/assets/img/partner/partner_5.png')}}" alt="image" />
                    <img src="{{asset('public/front/assets/img/partner/partner_hover_5.png')}}" alt="partner" />
                </div>
                <div class="partner-item">
                    <img src="{{asset('public/front/assets/img/partner/partner_6.png')}}" alt="image" />
                    <img src="{{asset('public/front/assets/img/partner/partner_hover_6.png')}}" alt="partner" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                    ...
                    <div class="blog-item-single">
                        <div class="blog-item-img">
                            <a href="blog-details.html">
                                <img src="{{asset('public/front/assets/img/blog/blog_1.png')}}" alt="blog-bg-image" />
                            </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog-item-single">
                        <div class="blog-item-img">
                            <a href="blog-details.html">
                                <img src="{{asset('public/front/assets/img/blog/blog_2.png')}}" alt="blog-bg-image" />
                            </a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog-item-single">
                        <div class="blog-item-img">
                            <a href="blog-details.html">
                                <img src="{{asset('public/front/assets/img/blog/blog_3.png')}}" alt="blog-bg-image" />
                            </a>
                            <p class="tag">Brand</p>
                        </div>
                        <div class="blog-item-content">
